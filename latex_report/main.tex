...
However, \cite{RefWorks:shalev-shwartz2017failures} found that for complex problems where the hypothesis
space involves a larger set of uncorrelated solution functions, Deep Neural Networks suffer from
...
gradient issue is likely to be prevalent in cases where MLPs are used as CTR classifiers directly.
