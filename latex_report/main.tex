...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{../figures/kdd12_model_scores.png}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{../figures/avazu_model_scores.png}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{../figures/criteo_model_scores.png}
\end{figure}
