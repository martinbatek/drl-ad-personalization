...
\begin{enumerate}
    ...
    \item \textbf{DNN shape:} Here we compared the predictive performance when using the following
    DNN hidden unit settings:
    \begin{itemize}
        \item \emph{Constant:} $[400,400,400]$
        \item \emph{Increasing:} $[300,400,500]$
        \item \emph{Decreasing:} $[500,400,300]$
        \item \emph{Diamond:} $[300,600,300]$
    \end{itemize}.
\end{enumerate}
