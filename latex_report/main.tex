...
Bound RL (UCBRL) algorithm \citep{RefWorks:auer2008near-optimal} and the
...
thereby making it more scalable to large and sparce datasets. 

\subsubsection{Reasearch Question and Contributions}
