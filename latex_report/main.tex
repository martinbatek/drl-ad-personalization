...
as the ML in the model architecture \citep{RefWorks:zhang2021deep}. The example of this is the 
so-called \textbf{Wide and Deep} model developed by \cite{RefWorks:cheng2016wide}:
