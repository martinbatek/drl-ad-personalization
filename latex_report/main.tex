...
\begin{itemize}
    ...
    However, this can be misleading in cases where label imbalance is prevalent. For the experiments in this report,
    ...
    In the context of Ad personalization, the Precision metric can be seen as an indicator of quality
